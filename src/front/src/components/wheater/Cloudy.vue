    ...
    <div>
        <svg style="width: 100%; height: 500px" version="1.1" id="mostlyCloudyIcon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="70px" height="70px" viewBox="0 0 70 70" enable-background="new 0 0 70 70" xml:space="preserve">
            <g id="sunIcon">
                ...
                <g id="middleRepeat" data-svg-origin="27.699999809265137 33.79999828338623" transform="matrix(0.95376,0,0,0.95376,1.2808479911804014,1.5629119206237618)">
                    <circle id="middle" fill="#FFD766" cx="27.7" cy="33.8" r="13.4" data-svg-origin="27.699999809265137 33.79999828338623" transform="matrix(1,0,0,1,0,0)"></circle>
                </g>
                <circle id="inner" fill="#FFBC00" cx="27.7" cy="33.8" r="10.1" data-svg-origin="27.70000171661377 33.80000019073486" transform="matrix(1,0,0,1,0,0)"></circle>
            </g>
            <g id="cloudRight" style="opacity: 1;">
                <path fill="#D1D3D4" d="M68.5,33.1c0,2.1-2.4,3.8-5.3,3.8H31.4c-2.9,0-5.3-1.7-5.3-3.8l0,0c0-2.1,2.4-3.8,5.3-3.8h31.8
                    C66.2,29.3,68.5,31,68.5,33.1L68.5,33.1z"></path>
                <circle fill="#FFFFFF" cx="45.6" cy="24.1" r="6.9"></circle>
                <circle fill="#D1D3D4" cx="53.2" cy="28.6" r="6.4"></circle>
                <path fill="#FFFFFF" d="M53.2,22.2c-1.5,0-2.9,0.5-4,1.4c-0.7,1-1.1,2.3-1.1,3.6c0,3.6,2.9,6.4,6.4,6.4c1.4,0,2.6-0.4,3.6-1.1
                    c0.9-1.1,1.4-2.5,1.4-4C59.6,25.1,56.7,22.2,53.2,22.2z"></path>
                <circle fill="#D1D3D4" cx="64.4" cy="32.8" r="4.1"></circle>
                <circle fill="#D1D3D4" cx="30.6" cy="31.6" r="5.3"></circle>
